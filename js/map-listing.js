(function ($) {
    ...
    function mainMap() {
        ...
        var locations = [
            ...
            [locationData('listing-single.html', 'images/kfz-fotos/s-DriveGaleri4.jpg', 'S-Drive New York Office', "9443 Fairview Ave, North Bergen, NJ", 'gym-cat', "4", "8","open"  ), 40.67386831, -74.10438536, 10,  'images/kfz-fotos/logo.png'],
        ];
	    //   Map Infoboxes end ------------------
